...
from DMNVisionTool_backend.tables.table_predictions import TablePrediction  #,Text
from DMNVisionTool_backend.tables.table_elements import TableHeader, TableHitPolicy
