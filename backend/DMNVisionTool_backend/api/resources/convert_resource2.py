...
def convert_images(path_left, path_right, sketchLeft, graphLeft, elementsLeft, ocrLeft, flowsLeft, decisionLogicLeft, sketchRight, graphRight, elementsRight, ocrRight, flowsRight, decisionLogicRight ):
    ...
    """
    # COMMENT FOR TESTING WITHOUT HANDLING REQUEST
    ...
    for idx, (ocr_img, predict_img, sketch_field, graph_field, elements_field, ocr_field, flow_field, decisionLogic_field) in enumerate(
        ...
        print('sketch_field:',sketch_field)
        print('graph_field:',graph_field)
        print('decisionLogic_field:', decisionLogic_field)
        
        # PDF + GRAPH
        if sketch_field == 'false':
            if graph_field == 'true':
        ...
        # PDF + TABLE
            elif sketch_field == 'false' and decisionLogic_field == 'true':
            ...
            # ELSE 
                ...
                print('There is something wrong, pdf image is neither a graph neither a table')
        
        # SKETCH + GRAPH
        elif sketch_field == 'true':
            if graph_field == 'true':
        ...
        # SKETCH + TABLE
            ...
            # OTHER
                ...
                print('There is something wrong, sketch image is neither a graph neither a table')
                
        else:
            print('Something is wrong, file is neither a sketch neither a pdf')
