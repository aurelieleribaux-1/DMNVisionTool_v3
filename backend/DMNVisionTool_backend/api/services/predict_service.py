...
class ObjectPredictor:
    """Class used to represent a Detectron2 predictor trained with a faster_rcnn (PDF versions)"""
...
# added this for the hanwritten model predictions     
